...
int main(void)
{
  ...
  to_hash.buffer = (uint8_t*)&L6_data.msg;
  to_hash.length = 256;

  uint8_t (*hash_out)[32] = &L6_data.msg_dig0;
  uint8_t (*rnd_buff)[256] = &L6_data.msg;
  ...
  uint8_t (*digest)[32] = &L6_data.msg_dig0;
  uint8_t* signature = &L6_data.sig_dig0;
  uint16_t signature_length = sizeof(L6_data.sig_dig0);
